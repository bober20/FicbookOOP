...
public partial class StoryInfoPage : ContentPage
{
    ...
    public StoryInfoPage(Story selectedStory)
    {
        ...
        BindingContext = _storyInfoViewModel = new StoryInfoViewModel(selectedStory);
    }

    private void OnShowLabelTapped(object sender, TappedEventArgs e)
    {
        Navigation.PushAsync(new ShowInfoPage(new ShowInfoViewModel(_storyInfoViewModel.Show)));
    }
